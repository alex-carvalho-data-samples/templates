# <img src="img/terraform.png" alt="terraform" width="30" style="vertical-align: middle;"> | airflow with local executor and PostgreSQL backend db <!--TODO: CHANGE_ME--> | infra #
